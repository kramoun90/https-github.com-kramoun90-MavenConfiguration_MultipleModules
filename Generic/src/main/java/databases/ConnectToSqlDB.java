...
public class ConnectToSqlDB {
    ...
    /*public void insertDataFromArrayListToSqlTable(List<databases.Student> list, String tableName, String columnName)
    {
        try {
            connectToSqlDatabase();
            ps = connect.prepareStatement("DROP TABLE IF EXISTS `"+tableName+"`;");
    ...
    public static List<databases.User> readUserProfileFromSqlTable()throws IOException, SQLException, ClassNotFoundException {
        List<databases.User> list = new ArrayList<>();
        databases.User user = null;
        try{
            ...
            while (rs.next())
            {
                ...
                user = new databases.User(name,id, dob);
                list.add(user);
    ...
    public static void main(String[] args)throws IOException, SQLException, ClassNotFoundException {
        List<databases.User> list = readUserProfileFromSqlTable();
        for(databases.User user:list){
